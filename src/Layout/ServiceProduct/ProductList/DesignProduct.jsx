...
import { imgdis1, imgdis2, imgdis3, imgdis4, imgdis5, imgdis6 } from '../img/index'
...
function DesignProduct() {
  return (
    ...
    <div className='py-5 ml-5 w-full xs1:w-[300px] md2:w-[240px] flex items-center gap-3 '>
       <h1 className='text-white text-lg w-fit'>Design Products</h1>
    ...
    <div className='w-full h-auto flex justify-center md:justify-between flex-wrap gap-6 '>
      ...
      <div className='h-auto w-11/12 sm:w-[70%] md:w-[19.1rem] md2:w-[22.5rem]'>
        <div className="rounded-2xl mx-auto border-[#414141] backdrop-blur-md border-b-[1px] border-r-[1.7px] border-l-[1px] border-t-[1.7px]">
          <img src={imgdis2} alt="imgtem1" className='w-full rounded-2xl' />
        </div>
      ...
      <div className='h-auto w-11/12 sm:w-[70%] md:w-[19.1rem] md2:w-[22.5rem]'>
        <div className="rounded-2xl mx-auto border-[#414141] backdrop-blur-md border-b-[1px] border-r-[1.7px] border-l-[1px] border-t-[1.7px]">
          <img src={imgdis3} alt="imgtem1" className='w-full rounded-2xl' />
        </div>
      ...
      <div className='h-auto w-11/12 sm:w-[70%] md:w-[19.1rem] md2:w-[22.5rem]'>
        <div className="rounded-2xl mx-auto border-[#414141] backdrop-blur-md border-b-[1px] border-r-[1.7px] border-l-[1px] border-t-[1.7px]">
          <img src={imgdis4} alt="imgtem1" className='w-full rounded-2xl' />
        </div>
      ...
      <div className='h-auto w-11/12 sm:w-[70%] md:w-[19.1rem] md2:w-[22.5rem]'>
        <div className="rounded-2xl mx-auto border-[#414141] backdrop-blur-md border-b-[1px] border-r-[1.7px] border-l-[1px] border-t-[1.7px]">
          <img src={imgdis5} alt="imgtem1" className='w-full rounded-2xl' />
        </div>
      ...
      <div className='h-auto w-11/12 sm:w-[70%] md:w-[19.1rem] md2:w-[22.5rem]'>
        <div className="rounded-2xl mx-auto border-[#414141] backdrop-blur-md border-b-[1px] border-r-[1.7px] border-l-[1px] border-t-[1.7px]">
          <img src={imgdis6} alt="imgtem1" className='w-full rounded-2xl' />
        </div>
